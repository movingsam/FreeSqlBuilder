...
var map = {
	"./project/project.module": [
		...
		"default~project-project-module~template-template-module",
		"project-project-module"
	],
...
/* harmony import */ var _base_commonInterceptor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./base/commonInterceptor */ "./src/app/base/commonInterceptor.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [{ provide: ng_zorro_antd__WEBPACK_IMPORTED_MODULE_8__["NZ_CONFIG"], useValue: ngZorroConfig },
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _base_commonInterceptor__WEBPACK_IMPORTED_MODULE_5__["CommonInterceptor"], multi: true
                }],
...
var AppRoutes = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(appRoutes);
...
/***/ "./src/app/base/commonInterceptor.ts":
/*!*******************************************!*\
  !*** ./src/app/base/commonInterceptor.ts ***!
  \*******************************************/
/*! exports provided: CommonInterceptor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommonInterceptor", function() { return CommonInterceptor; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var CommonInterceptor = /** @class */ (function () {
    function CommonInterceptor(message) {
    ...
    CommonInterceptor.prototype.intercept = function (req, next) {
        ...
        return next.handle(req)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (event) {
            // 正常返回，处理具体返回参数
            if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"] && event.status === 200) {
                return _this.handleData(event);
            } // 具体处理请求返回数据
    ...
    CommonInterceptor.prototype.handleData = function (event) {
        var errorMsg = '';
        // 业务处理：一些通用操作
        switch (event.status) {
            case 200:
    ...
    CommonInterceptor.ctorParameters = function () { return [
...
module.exports = __webpack_require__(/*! D:\Project\FreeSqlGeneratorClient\ClientApp\src\main.ts */"./src/main.ts");
