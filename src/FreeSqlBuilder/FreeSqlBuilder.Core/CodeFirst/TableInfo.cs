...
//        {
//        }
//        public TableInfo(Internal.Model.TableInfo tableInfo)
//        {
//            this.Name = tableInfo.CsName;
//            this.NameSpace = tableInfo.Type.Namespace;
//            this.PrimaryTypeName = string.Join(",", tableInfo.Primarys.Select(x => x.CsType));
//            this.ImportUsings = tableInfo.Properties.Select(x => x.Value.PropertyType.Namespace).Distinct().ToList();
//        }
